...
onMounted(() => {
    ...
    if (route.params.applicationId) {
        appResponse = detailApplication(route.params.organizationId as string, route.params.applicationId as string, route.params.environment as string)
            .then((response) => {
