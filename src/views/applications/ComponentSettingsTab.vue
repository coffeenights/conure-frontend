...
import { ComponentSettingsSchema, createVariable } from '@/services/variables'
...
const { handleSubmit, isSubmitting, setFieldValue, validateField } = useForm({
...
<template>
  <form @submit="onSubmit">
          ...
          <FormField v-slot="{ componentField }" name="networkExpose">
            <FormItem class="flex flex-col">
              ...
              <FormControl>
                ...
                <FormDescription>
                  Activate if you want to expose the component to other
                  components in the application or to the outside world
                </FormDescription>
              </FormControl>
              <FormMessage />
            </FormItem>
    ...
    <div class="flex w-full my-5">
      <Button type="submit" :disabled="isSubmitting" class="grow">Save</Button>
    </div>
  </form>
</template>
